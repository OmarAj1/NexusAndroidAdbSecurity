...
const AppRow = memo(({ app, isSelected, onToggle, onAction }: any) => {
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex items-center gap-1">
          ...
          {/* 4. UNINSTALL (Always visible unless uninstalled) */}
          {!isUninstalled && (
            <button
    ...
    <div className="flex flex-col gap-3 pb-24">
      {apps.map((app) => (
        <AppRow
          key={app.pkg}
          app={app}
          isSelected={selectedApps.has(app.pkg)}
          onToggle={onToggle}
          onAction={onAction}
        />
      ))}
